...
<div class="space-y-6 fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
             ...
             <!-- Tambah Button -->
             <a href="index.php?halaman=mengajar_tambah" class="bg-primary-600 text-white hover:bg-primary-700 px-4 py-2 rounded-xl text-sm font-medium transition flex items-center justify-center shadow-sm">
